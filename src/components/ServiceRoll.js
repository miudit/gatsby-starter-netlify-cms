      ...
      <div className="content">
        <div className="columns desktop-hidden">
          ...
          <div className="column is-6">
            <p>
            AIの技術が身近なものとなり、日常の一部になって欲しい、そんな思いからこのサービスは始まりました。 AIによる画像解析は、小売販売を無人化するだけでなく、普段の消費活動に驚きをもった新鮮さを与えてくれます。
            1人でも多くの方々にこれらの経験をして頂くもらうために、企業様へのシステム提供および自社で小売販売を展開しております。 ブースを1ユニットとして、1台はもちろん複数台とすることで、より多く、より広いスペースまでカバーすることができます。
            画像AIによる無人販売に興味をお持ちの企業様、弊社の無人販売ブースを設置したい企業様、弊社の無人販売ブースに出品したい企業様、など興味ある方はお気軽に、admin@bestat-data.com、までご連絡ください。
            もちろん、その他弊社サービスにご関心ある方からのご連絡もお待ちしております。
            </p>
          </div>
        </div>
